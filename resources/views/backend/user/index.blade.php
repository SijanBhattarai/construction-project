            ...
            <div class="card-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{route('user.show', $user->name)}}" class="btn btn-flat btn-primary btn-xs">
                                View
                            </a>
                            <a href="{{route('user.edit', $user->name)}}" class="btn btn-flat btn-primary btn-xs">
                                Edit
                            </a>
                            <button type="button" data-url="{{ route('user.destroy', $user->name) }}" class="btn btn-flat btn-primary btn-xs item-delete">
                                Delete
                            </button>
                        </td>
                    </tr>
